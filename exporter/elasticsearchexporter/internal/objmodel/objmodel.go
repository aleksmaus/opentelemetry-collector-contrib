...
var otelPrefixes = []string{"attributes.", "resource.attributes.", "scope.attributes."}

var otelPrefixSet = map[string]struct{}{}

func init() {
	otelPrefixSet = make(map[string]struct{})
	for _, pfx := range otelPrefixes {
		otelPrefixSet[pfx] = struct{}{}
	}
}
